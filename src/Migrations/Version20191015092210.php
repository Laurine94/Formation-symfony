 ...
 */
final class Version20191015092210 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDE8B7E4006 FOREIGN KEY (booker_id) REFERENCES utilisateur (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
